    ...
    <section id='about' className="py-20 md:py-32">
      <div className="container mx-auto px-4">
        <div className=" max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-lg md:text-xl text-slate-900-300">
            <p>
              I'm a passionate Software Engineer with a Bachelor's degree in Computer Science and Engineering from IMS Engineering College. 
